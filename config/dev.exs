...
config :shilingi_guard, ShilingiGuardWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ofhYUspnCA4gHRGO3X6oG11X0GzT4nouSqbDjQEjCiIpDM91TTqyM/nEbj8I4i+l",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:shilingi_guard, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:shilingi_guard, ~w(--watch)]}
  ]
...
config :shilingi_guard, dev_routes: true
