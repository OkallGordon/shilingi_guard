defmodule ShilingiGuardWeb.UserAuthTest do
  use ShilingiGuardWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias ShilingiGuard.Accounts
  alias ShilingiGuard.Accounts.Scope
  alias ShilingiGuardWeb.UserAuth
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ShilingiGuardWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        ShilingiGuardWeb.Endpoint.subscribe("users_sessions:#{Base.url_encode64(token)}")
      end
